...
month_indices %>% 
  ...
  select(-total) %>% 
  kable(format = "latex",
        caption = "List countries and geartypes where China has had at least one hour of foreign fishing activity between 2012 and 2018, as identified by Global Fishing Watch (www.globalfishingwatch.org). An asterisk (*) indicates knowledge of an existing agreement. Countries are sorted in descending order according to the total ammount of foreign fishing hours.",
