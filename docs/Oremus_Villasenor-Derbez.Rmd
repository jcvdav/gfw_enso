...
gridded_ff <- read_csv(file = here("raw_data", "GFW", "gridded_ff_by_gear_country.csv"),
                       col_types = cols(),
                       progress = F) %>% 
  filter(best_label %in% c("drifting_longlines", "purse_seines")) %>% 
...
```{r}
world_coastline <- sf::st_read(dsn = here("raw_data", "spatial"), layer = "world_coastline", quiet = T)
```
...
```{r}
sst_df <- readRDS(here::here("data", "sst_df.rds"))
```
...
stargazer::stargazer(models,
                     ...
                     add.lines = list(c("Gear FE", "No", "Yes", "Yes", "Yes"),
                                      c("Month FE", "No", "No", "Yes", "Yes"),
                                      c("Country FE", "No", "No", "No", "Yes")),
